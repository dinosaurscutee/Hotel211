...
namespace BookingHotel.Models
{
    public class HotelDbContext : DbContext
    {
        ...
        private void seedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RoomRoomAmenities>().HasData(
                new RoomRoomAmenities {AmenityID = 1, RoomID=1  },
                new RoomRoomAmenities {AmenityID = 2, RoomID=2  },
                new RoomRoomAmenities {AmenityID = 3, RoomID=3  },
                new RoomRoomAmenities {AmenityID = 4, RoomID=4  },
                new RoomRoomAmenities {AmenityID = 5, RoomID=5  }
            );
